            ...
            files.forEach(file_path => {
                ...
                file_destination.delete()
                    .then(r => {
                        ...
                        db.database().ref('snapshots/' + snap_id).remove()
                            .then(() => {
                                console.log(`Successfully deleted snapshot ${snap_id} from database`);
                            })
